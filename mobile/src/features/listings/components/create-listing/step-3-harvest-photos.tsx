...
export default function Step3HarvestPhotos({
  ...
  const handleShowHelp = () => {
    Alert.alert(
      ...
      "Attach clear photos of your harvest. Wholesale buyers check clarity & natural lighting before placing bids."
    );
  };
        ...
        <VStack className="gap-3 pt-2">
          <HStack className="items-center justify-between">
            ...
            <VStack className="items-center">
              ...
              <Text className="type-title text-foreground">Add Harvest Photos</Text>
            </VStack>
          ...
          {/* Progress bar track (60% for Step 3) */}
          <Box className="h-1.5 w-full overflow-hidden rounded-pill bg-muted">
            <Box className="h-full w-3/5 rounded-pill bg-brand-deep" />
          </Box>
        </VStack>
      ...
      >
        ...
        <HStack className="gap-2">
          ...
          <View className="flex-1">
            <AppButton label="Continue" disabled={!isReady} onPress={handleContinue} />
          </View>
        </HStack>
      </View>
    </View>
