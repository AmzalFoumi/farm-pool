...
>(function IconWrapper({ ...props }, ref) {
  // withUniwind() rewraps UIIcon's ref as IPrimitiveIcon & RefAttributes<Svg>,
  // which no longer matches ComponentRef<typeof UIIcon> (gluestack-ui v5 alpha).
  // Same instance at runtime.
  return <StyledUIIcon {...props} ref={ref as React.ComponentProps<typeof StyledUIIcon>["ref"]} />;
});
...
// The body below reads `size`, `height` and `width`, but neither
// UICheckbox.Icon's props nor checkboxIconStyle's variants declare them
// (gluestack-ui v5 alpha). Declared here so the implementation type-checks.
